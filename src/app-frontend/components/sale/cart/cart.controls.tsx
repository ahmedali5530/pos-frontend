  ...
  return (
    <>
      <div className="p-3 block border-b flex gap-3 justify-end">
        <button disabled={added.length === 0} type="button" className="btn btn-danger" onClick={voidCartItems}>Void</button>
        <button disabled={added.length === 0} type="button" className="btn btn-secondary" onClick={copyCartItems}>Copy</button>
        {/*<button type="button" className="btn btn-secondary"><FontAwesomeIcon icon={faPencil}/></button>*/}
        <button disabled={added.length === 0} type="button" className="btn btn-secondary" onClick={() => setQtyModal(true) }>QTY</button>
        <button disabled={added.length === 0} type="button" className="btn btn-secondary" onClick={() => setDiscModal(true)}>Disc.</button>
        <button disabled={added.length === 0} type="button" className="btn btn-secondary" onClick={toggleTax}>Toggle Tax</button>
      </div>
