...
export const GeneralSetting = () => {
  ...
  useEffect(() => {
    const loadSettings = async () => {
      const [setting] = await db.query(`SELECT *
                                        FROM ${Tables.setting}
                                        where name = $name
                                          and terminal = $terminal FETCH
  ...
  return (
    <div>
      <div className="grid grid-cols-2 gap-5 my-5">
        <div className="shadow-xl bg-white rounded-xl overflow-hidden border border-gray-300">
          <div className="p-5 border-b border-gray-300 bg-gray-100 text-gray-900">User information</div>
        ...
        <div className="shadow-xl bg-white rounded-xl overflow-hidden border border-warning-300">
          <div className="p-5 border-b border-warning-300 bg-warning-100 text-warning-900">Cache</div>
          <div className="flex-col gap-5 justify-start p-5">
            ...
            <div>
              <Button
                ...
                className="mr-3 flex-grow-0 gap-3 btn-flat active"
                size="lg"
                disabled={isLoading}>
                {isLoading ? "Reloading..." : (
                  <>
      ...
      <div className="grid grid-cols-2 gap-5">
        <div className="shadow-xl bg-white rounded-xl border border-primary-300 mb-5">
